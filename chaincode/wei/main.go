...
func (t *BookChaincode) invoke(stub shim.ChaincodeStubInterface, args []string) pb.Response {
...
func (t *BookChaincode) delete(stub shim.ChaincodeStubInterface, args []string) pb.Response {
...
func (t *BookChaincode) update(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	return t.handleProcess(stub, args, 3, func(shim.ChaincodeStubInterface, []string) *ResInfo {
		ri := &ResInfo{true, ""}
		_id := args[0]
		_content := args[1]
...
func (t *BookChaincode) updateTxid(stub shim.ChaincodeStubInterface, args []string) pb.Response {
...
func (t *BookChaincode) handleProcess(stub shim.ChaincodeStubInterface, args []string, expectNum int, f process) pb.Response {
	res := &ResInfo{false, ""}
...
func (t *BookChaincode) checkArgs(args []string, expectNum int) error {
...
func (t *BookChaincode) test(stub shim.ChaincodeStubInterface, args []string) pb.Response {
